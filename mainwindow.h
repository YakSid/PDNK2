...
// TODO: MAIN удаление(удаления детей нет пока, блокируется вкопировании), при удалении mainParent делать
// additionalParent мэйном если нет других, обработать ситуацию, когда от родителя к ноду идёт несколько линий

// TODO: позже Проверку "есть ли провал у каждой из первых трех"
// TODO: релиз: tooltip id заменить на какой-нибудь текст?
// TODO: релиз: сделать предупреждение, чтобы с циклами не перебарщивали
// TODO: позже: поправить лейауты награды и финальном
namespace Ui {
class MainWindow;
}
