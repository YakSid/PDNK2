...
// TODO: 2 min: tooltip id заменить на какой-нибудь текст?
// TODO: релиз энд: предупреждение, что перед именами сотрудников указывать @ сделать предупреждение, чтобы с циклами не
// перебарщивали и после уменьшения кол-ва сотрудников во время создания, нужно проверить не остались ли пустые выборы в
