...
const QStringList THREAT_LEVELS = {
    "[1] Подготовка департаментов", "[2] Паника от неизвестности", "[3] Открытое противостояние", "[1]+[2]", "[2]+[3]",
    "Любой уровень, не важно"
};
const QStringList AWARNESS_INDEXES = { "[1] Департамент в неведении",
                                       "[2] Некоторые люди подозревают что-то",
                                       "[3] Почти все уверены",
                                       "[4] Департамент осведомлён",
                                       "Любой уровень, не важно",
                                       "[1]+[2]",
                                       "[1]+[2]+[3]",
                                       "[2]+[3]",
